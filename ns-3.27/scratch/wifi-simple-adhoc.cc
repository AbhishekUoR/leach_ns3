...
/*  p2p.SetDeviceAttribute ("DataRate", StringValue ("3Mbps"));
  p2p.SetChannelAttribute ("PacketSize", StringValue ("1500 Bytes"));
  NetDeviceContainer d0d2 = p2p.Install (n0n1);
*/
...
//  Ipv4InterfaceContainer i = ipv4.Assign (d0d2);
